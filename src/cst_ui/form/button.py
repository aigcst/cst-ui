...
from cst_ui.basic.theme import theme, StyleType
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.style = ft.ButtonStyle(
            ...
            shadow_color={
                # jui.theme[self.style_type].color_side_color,
                ft.ControlState.DEFAULT: theme[self.style_type].color,
                ft.ControlState.HOVERED: theme[self.style_type].color_light,
                ft.ControlState.DISABLED: ft.Colors.GREY_300,
                ft.ControlState.PRESSED: theme[self.style_type].color_accent,
            ...
            side={
                ...
                ft.ControlState.HOVERED: ft.BorderSide(1, theme[self.style_type].color_light),
                ft.ControlState.DISABLED: ft.BorderSide(1, ft.Colors.GREY),
                ft.ControlState.PRESSED: ft.BorderSide(1, theme[self.style_type].color_accent),
            },
        )
        if self.plain:
            self.style.bgcolor = {
                ft.ControlState.DEFAULT: ft.Colors.WHITE,
                # ft.ControlState.PRESSED: jui.theme[self.style_type].color_light_max,
            }
            # 点击样式
            ...
            self.style.side = {
                ...
                ft.ControlState.HOVERED: ft.BorderSide(1, theme[self.style_type].color_light),
                ft.ControlState.DISABLED: ft.BorderSide(1, ft.Colors.GREY),
                ft.ControlState.PRESSED: ft.BorderSide(2, theme[self.style_type].color_accent),
            }
            self.style.color = {
        ...
        if self.shape_type == ButtonShapeType.rect:
            ...
            self.style.shape = ft.RoundedRectangleBorder(radius=theme.border_radius.large)
...
def main(page: ft.Page):
    ...
    page.add(
        ...
        ft.Row(
            controls=[
                Button(text='color_button', style_type=StyleType.DEFAULT, plain=True, disabled=True),
                Button(text='primary_button', style_type=StyleType.PRIMARY, plain=True, disabled=True),
                Button(text='success_button', style_type=StyleType.SUCCESS, plain=True, disabled=True),
                Button(text='info_button', style_type=StyleType.INFO, plain=True, disabled=True),
                Button(text='warning_button', style_type=StyleType.WARNING, plain=True, disabled=True),
                Button(text='error_button', style_type=StyleType.ERROR, plain=True, disabled=True),
            ]
        ),
        ft.Text('icon_button'),
